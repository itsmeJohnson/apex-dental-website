  ...
  return (
    <>
      ...
      <div className="hidden lg:block bg-dark text-slate-200 text-xs py-2 px-6 border-b border-slate-800">
        <div className="max-w-[1680px] mx-auto flex justify-between items-center font-medium">
      ...
      >
        <div className="max-w-[1680px] mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
          {/* Logo */}
